...
async def upload_students(
    ...
    try:
        ...
        await db_ops.delete_many('students', {"examId": exam_id})
        ...
        # Insert students one by one since SQLite doesn't have insert_many
        for student in students:
            await db_ops.insert_one('students', student)
...
async def get_students(exam_id: str, db_ops=Depends(get_database)):
    try:
        students = await db_ops.find_many('students', {"examId": exam_id}, sort_by="copyNumber", sort_order="ASC")
